...
pipeline {
  ...
  environment {
    ...
    NEXUS_CREDENTIAL_ID = 'Nexux-credential'
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://172.31.61.89:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#cicd-pipeline-project-olaoluwaa', //update and provide your channel name
